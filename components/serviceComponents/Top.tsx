...
const Top = () => {
  return (
    <div className=' w-full h-[35vh] dark:bg-black bg-white  dark:bg-grid-white/[0.1] bg-grid-black/[0.1] relative'>
       {/* Radial gradient for the container to give a faded look */}
      <div className="absolute pointer-events-none inset-0 flex items-center justify-center dark:bg-black bg-white [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"/>
       <div className='max-container padding-container h-full flex items-center justify-center mt-5'>
        <div className='flexCenter flex-col gap-4 my-14'>
        <h1 className='bold-32 lg:bold-52'>Our Services</h1>

  ...
  return (
    <div className='max-container padding-container flex flex-col gap-2'>
      <div className="my-6 flexCenter flex-col gap-1 text-center">
        <h1 className="bold-20 lg:bold-32">Featured Services</h1>
      ...
      <BentoGrid className="w-full md:auto-rows-[20rem]">
        {items.map((item, i) => (
          <BentoGridItem
            ...
            header={(
              <div className="relative w-full h-full min-h-[9rem] rounded overflow-hidden shadow-md dark:shadow-none">
